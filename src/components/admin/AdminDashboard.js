    ...
    return (
        <div className="admin_dashboard_container">
            <div className="admin_side_panel">
                ...
                <button 
                    className="unassigned_btn"
                    style={{ 
                        backgroundColor: selection.unassigned ? "#fff":"transparent",
                        color: selection.unassigned ? "rgb(36,40,80)":"#fff"
                     }}
                     onClick={() => {
                         setselection({
                             unassigned: true,
                ...
                <button 
                    ...
                    style={{ 
                        backgroundColor: selection.classes ? "#fff":"transparent",
                        color: selection.classes ? "rgb(36,40,80)":"#fff"
                    }}
                    onClick={() => {
                        setselection({
                            unassigned: false,
